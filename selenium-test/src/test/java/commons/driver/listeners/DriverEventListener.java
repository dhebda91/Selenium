...
public class DriverEventListener implements WebDriverListener {
    ...
    //W klasie należy zaimplementować wybrane metody z interfejsu WebDriverListener, następnie dodać prywatną,
    // statyczną instancję loggera oraz logowanie do każdej z metod:
